...
class HC_ward_medoid:
    ...
    def updata(self):
        ...
        new_dsim_list, new_medoid_list, new_e_g_list = self.cal_dsim(cluster_1_index = min_dsim_list_index[0][0], cluster_2_index = min_dsim_list_index[1][0]) #追加する非類似度行列を取得
        new_cluster = Cluster(data_list = np.append(cluster_1.get_data_list(), cluster_2.get_data_list()), cluster_list = np.array([cluster_1, cluster_2]), dsim = min_dsim, medoid = self.medoid_list[min_dsim_list_index[0][0], min_dsim_list_index[1][0]], e_g = self.e_g_list[min_dsim_list_index[0][0], min_dsim_list_index[1][0]]) #クラスタ作成
        ...
        self.medoid_list = np.delete(self.medoid_list, min_dsim_list_index[0][0], 0)
        self.medoid_list = np.delete(self.medoid_list, min_dsim_list_index[0][0], 1)
        self.medoid_list = np.delete(self.medoid_list, min_dsim_list_index[1][0], 0)
        self.medoid_list = np.delete(self.medoid_list, min_dsim_list_index[1][0], 1)
        self.e_g_list = np.delete(self.e_g_list, min_dsim_list_index[0][0], 0)
        self.e_g_list = np.delete(self.e_g_list, min_dsim_list_index[0][0], 1)
        self.e_g_list = np.delete(self.e_g_list, min_dsim_list_index[1][0], 0)
        self.e_g_list = np.delete(self.e_g_list, min_dsim_list_index[1][0], 1)
