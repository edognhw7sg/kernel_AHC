...
class HC_average_linkage_within:
    def __init__(self, input_data):
        ...
        self.dsim_dash_list = self.dsim_list
    ...
    def updata(self):
        ...
        new_dsim_list, new_dsim_dash_list, I_g_i = self.cal_dsim(cluster_1_index = min_dsim_list_index[0][0], cluster_2_index = min_dsim_list_index[1][0]) #追加する非類似度行列を取得
        ...
        self.dsim_dash_list = np.delete(self.dsim_dash_list, min_dsim_list_index[0][0], 0)
        self.dsim_dash_list = np.delete(self.dsim_dash_list, min_dsim_list_index[0][0], 1)
        self.dsim_dash_list = np.delete(self.dsim_dash_list, min_dsim_list_index[1][0], 0)
        self.dsim_dash_list = np.delete(self.dsim_dash_list, min_dsim_list_index[1][0], 1)
