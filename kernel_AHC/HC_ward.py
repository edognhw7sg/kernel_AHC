...
class HC_ward:
    ...
    def cal_dsim(self, cluster_1_index, cluster_2_index):
        ...
        for cluster_index in range(self.cluster_list.shape[0]):
            ...
            new_dsim_list = np.append(new_dsim_list, (((cluster_1_num + cluster_num) * dsim_1) + ((cluster_2_num + cluster_num) * dsim_2) - (cluster_num * cluster_dsim)) / (cluster_1_num + cluster_2_num + cluster_num))
